...
export function FloatingChat({
  ...
  // Load minimized state from localStorage, default to minimized
  ...
  return (
    <div
      className={cn(
        ...
        // Desktop: fixed bottom-left (narrow width)
        "md:bottom-4 md:left-4 md:w-[400px] md:max-w-[calc(100vw-2rem)] md:rounded-lg",
        // Height based on minimized state
        isMinimized ? "h-[60px]" : ""
      )}
      style={{
